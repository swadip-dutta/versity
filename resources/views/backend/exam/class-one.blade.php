...
@section('content')
    ...
    <div class="sl-pagebody">
        ...
        <h6 style=" font-size: 12px; margin-top: -18px; margin-left:
                            84px;" class="tx-white">{{ $item->title }}</h6>
                            ...
                            <div class="d-flex align-items-center justify-content-between mg-t-15 bd-t bd-white-2 pd-t-10">
                                <div style="margin-top: -12px;">
                                    ...
                                    <h6 style="font-size: 12px;" class="tx-white mg-b-0">
                                        {{ $item->google_class_join_code }}</h6>
                                </div>
                                <div>
                                    <span style="display: block; margin-left: 15px;" class="tx-11 tx-white-6">Exam
                                        Link</span>
                                    <a style="font-size: 12px;" href="{{ $item->exam_link }}"
                                        class="tx-white btn btn-dark">Click Here</a>
                                </div>
                            </div><!-- -->
                    </div><!-- card -->
